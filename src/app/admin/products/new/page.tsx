        ...
        <form action={submitNewProduct} className="p-8 space-y-8">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">URL Ảnh Thumbnail (Bắt buộc) *</label>
                <input required type="url" name="thumbnailUrl" placeholder="https://..." className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 text-gray-900 bg-white" />
              </div>
              <div>
