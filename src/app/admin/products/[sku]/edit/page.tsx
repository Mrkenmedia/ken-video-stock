          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input required type="text" name="driveDemoId" defaultValue={product.driveDemoId} placeholder="VD: 1Bxy..." className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 font-mono text-sm text-gray-900 bg-white" />
              </div>
            </div>
          </div>
